...
public class CountSwitch {

	public static class SwitchCountMapper extends Mapper<Object, Text, Text, IntWritable> {
	...
	public static class SwitchCountReducer extends Reducer<Text, IntWritable, Text, IntWritable> {
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(CountSwitch.class);

		job.setMapperClass(SwitchCountMapper.class);
		...
		job.setReducerClass(SwitchCountReducer.class);
